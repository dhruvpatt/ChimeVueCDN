...
Vue.component('upper-box', {
    ...
    created: function(){
        EventBus.$on('resultClicked', this.handleResultClicked)
    },

    template: `
        <div class='container'>
            <div class='upper-box'>
                <search-bar v-on:search="handleSearch" v-if="!searched"></search-bar>
                ...
                <div class="searched-container" v-else-if="searched">
                    <div class="title-bubble">
                        <img id='icon' v-bind:src="getIcon" />
                        <p class="title-bubble-txt">{{ searchItem.type.toUpperCase() }}</p>
                        <button id='exit-button' v-on:click="handleExitButtonClick">
            ...
            <div class='info-container' v-if="searched">
                <div class='info-img-container'>
                    <img id='info-img' v-bind:src="getIcon128" />
                </div>
                   
                <div class='info-sub-container'>
                    <info-text v-for="(item, key, index) in searchItem" v-bind:attr="key" v-bind:item="item"></info-text>
                </div>
            </div>
